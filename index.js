...
function hungryDog(dogWeight, dogAge) // ask question
{
...
function annoyingSong(number, i)
{
  for (i = number; i > 0; i--)
  {
...
function grade(score)
{
  ...
  {
    return "how the hell are you getting negative grades! Go hit the books";
  }
}
